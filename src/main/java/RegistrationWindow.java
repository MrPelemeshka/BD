...
public class RegistrationWindow extends JFrame {
    ...
    public RegistrationWindow() {
        ...
        JLabel lblNewLabel = new JLabel("–õ–æ–≥–∏–Ω");
        ...
        JLabel lblNewLabel_1 = new JLabel("–ü–∞—Ä–æ–ª—å");
        ...
        lblNewLabel_2 = new JLabel("–†–µ–≥–∏—Å—Ç—Ä–∞—Ü–∏—è");
    ...
    class SwingAction extends AbstractAction {
        public SwingAction() {
            putValue(NAME, "–ó–∞—Ä–µ–≥–∏—Å—Ç—Ä–∏—Ä–æ–≤–∞—Ç—å—Å—è");
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (connectionToDB != null && isCorrect) {
                try {
                    ...
                    error=false;
                    errorLabel.setText("Œ¯Ë·Í‡");
                }
                if(error)errorLabel.setText("”ÒÔÂ¯ÌÓ! «‡ÍÓÈÚÂ ÓÍÌÓ Â„ËÒÚ‡ˆËË");

            }
            else errorLabel.setText("Œ¯Ë·Í‡");
        }
    }
}
